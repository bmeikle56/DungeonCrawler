...
public class InitController extends RoomController {
    ...
    public void showHealthValue(int health) {
        healthValue.setText(String.valueOf(health * 100));
    }
    ...
    private void loadRoom(MouseEvent mouseEvent) throws IOException {
        ...
        System.out.println("Health: " + Player.round(Player.getHealth(), 2));
        System.out.println("Strength: " + Player.round(Player.getStrength(), 2));
        System.out.println("Coins: " + Player.getCoins() + "\n");
        System.out.println("Inventory: " + Inventory.print());
    }

    /**
     * Displays player's attributes on screen
     * @param room the room
     */
    private void display(RoomController room) {
        ...
        room.showHealthValue((int) (Player.round(Player.getHealth(), 2) * 100));
    }
}
