...
public class MinionRoomController extends RoomController {
    ...
    @FXML
    private ImageView minionMonster;
    @FXML
    private Label deadLabel;
    @FXML
    private ProgressBar minionBar;
    @FXML
    private Label minionValue;
    ...
    public void showMinionBar(double health) {
        minionBar.setProgress(health);
    }
    public void showMinionValue(int health) {
        minionValue.setText(String.valueOf(health));
    }
    ...
    public void clickFight(MouseEvent mouseEvent) throws IOException {
        ...
        Minion minion = ((MinionRoom) room).getMonster();
        ...
        showMinionBar(minion.getHealth());
        showMinionValue((int) (Player.round(minion.getHealth(), 2) * 100));
    }
